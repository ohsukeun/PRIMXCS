...
<script type="text/javascript" src="<c:url value='/js/egovframework/com/primx/fun/cmm/myPage.js' />"></script>
		    ...
		    <form action="">
		        ...
		        <ul class="listWrap mont">
		            <li>
		                ...
		                <div class="flexWrap">
		                    <input class="txtBox disabled" id="userId" type="text" value="" disabled>
		                </div>
		            </li>
		            <li>
		                <span class="tit">이메일</span>
		                <div class="flexWrap">
		                    <input class="txtBox disabled" id="email" type="text" value="" disabled>
		                </div>
		            </li>
		            <li>
		                <span class="tit">전화번호</span>
		                <input class="txtBox yEdit disabled" id="phoneNumber" type="text" value="" placeholder="'-'을 포함하여 입력하세요.(ex: 010-1234-6789)" disabled>
		            </li>
		            <li>
		                <span class="tit">사용자명</span>
		                <input class="txtBox yEdit disabled" id="userName" type="text" value="" placeholder="사용자명을 입력하세요." disabled>
		            </li>
		            <li>
		                <span class="tit">회사코드</span>
		                <input class="txtBox disabled" id="companyCode" type="text" value="" disabled>
		            </li>
		            <li class="pwSection hide">
		                <span class="tit">패스워드</span>
		                <div class="mb15">
		                    <input class="txtBox pwInput yEdit" id="currentPassword" type="password" placeholder="현재 패스워드 입력">
		                    <button type="button" class="pwViewBtn"></button>
		                </div>
		                <div class="mb15">
		                    <input class="txtBox pwInput yEdit" id="newPassword" type="password" placeholder="신규 패스워드 입력(최소 8자, 영문/숫자/특수문자 조합)">
		                    <button type="button" class="pwViewBtn"></button>
		                </div>
		                <div>
		                    <input class="txtBox pwInput yEdit" id="confirmPassword" type="password" placeholder="패스워드 확인">
		                    <button type="button" class="pwViewBtn"></button>
		                </div>
		            </li>
		            <li class="hide">
