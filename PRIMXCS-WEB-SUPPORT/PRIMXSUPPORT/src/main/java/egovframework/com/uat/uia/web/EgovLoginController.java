...
public class EgovLoginController {
	 ...
	 * 뷰 화면으로 들어간다
	 */
	@RequestMapping(value = "/uat/uia/view.do")
	public String commonView(ModelMap model) throws Exception {

		return "egovframework/com/uat/uia/view";
	}
	/**
	 * 로그인 화면으로 들어간다
	 ...
	 */
	/*
	 * @RequestMapping(value = "/uat/uia/actionLogout.do") public String
	 * actionLogout(HttpServletRequest request, ModelMap model) throws Exception {
	 * 
	 * //String userIp = EgovClntInfo.getClntIP(request);
	 * 
	 * // 1. Security 연동 //return "redirect:/j_spring_security_logout";
	 * 
	 * request.getSession().setAttribute("loginVO", null); // 세션모드인경우 Authority 초기화
	 * // List<String> authList =
	 * (List<String>)EgovUserDetailsHelper.getAuthorities();
	 * request.getSession().setAttribute("accessUser", null);
	 * 
	 * //return "redirect:/egovDevIndex.jsp"; return "redirect:/EgovContent.do"; }
	 */
	...
	public String actionLogout(HttpServletRequest request, ModelMap model) throws Exception {
	    ...
	    // 리디렉션 후 로그인 상태 갱신을 위한 페이지로 이동
	    return "redirect:/EgovContent.do";  // 로그인 상태 갱신을 위해 리디렉션
	}
