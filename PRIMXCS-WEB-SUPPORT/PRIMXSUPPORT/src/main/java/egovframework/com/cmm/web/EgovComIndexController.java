...
public class EgovComIndexController {
	...
	@RequestMapping("/PrimxTop.do")
	public String top() {
		return "egovframework/com/primx/fun/cmm/PrimxUnitTop";
	}

	@RequestMapping("/PrimxLeft.do")
...
//		LOGGER.debug("EgovComIndexController index is called ");
		...
		return "egovframework/com/primx/fun/cmm/PrimxUnitLeft";
	}
