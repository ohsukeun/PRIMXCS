...
//		xmlWebApplicationContext.setConfigLocation("/WEB-INF/config/egovframework/springmvc/egov-com-primx.xml");
...
//			egovSpringSecurityLoginFilter.setInitParameter("loginURL", "/primx/islogin.do");
			//로그인 처리 URL설정
			egovSpringSecurityLoginFilter.setInitParameter("loginProcessURL", "/uat/uia/actionLogin.do");
//			egovSpringSecurityLoginFilter.setInitParameter("loginProcessURL", "/primx/hello.do");
			//처리 Url Pattern
