/// @file pmx_agent_ctrl_main.cpp
/// @author Park, sung soo
/// @date 2023-06-29
/// PRIMX-CS agent control service main
...
#ifndef __PMX_AGENT_CTRL_MAIN_CPP__
#define __PMX_AGENT_CTRL_MAIN_CPP__
...
INT main(IN INT argc, PCHAR argv[])
{
	...
	// run main
	CAgentCtrlSvr* pObj = new CAgentCtrlSvr();
	if (FALSE == pObj->Init())
	{
...
//-----------------------------------------------------------------------------
#endif // __PMX_AGENT_CTRL_MAIN_CPP__
