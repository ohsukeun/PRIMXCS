...
#define PMX_XML_ELM_ZTRYMENUENABLE           "zTryMenuEnable"
#define PMX_XML_ELM_ZOPENAREA                "zOpenArea"
#define PMX_XML_ELM_ZPERSONALACCESS          "zPersonalAccess"
#define PMX_XML_ELM_ZOPTIONDISPLAY           "zOptionDisplay"
#define PMX_XML_ELM_ZSAFETYZONE              "zSafetyZone"
#define PMX_XML_ELM_ZAREACLOSE               "zAreaClose"
#define PMX_XML_ELM_ZENC	             "zEnc"
#define PMX_XML_ELM_TZONEMAP		     "tZoneMap"
...
#define PMX_XML_ELM_POLICYUPDATE	     "PolicyUpdate"	
// attributes
...
public:
	...
	WCString GetLastPolicyID    () { return m_sLastPolicyID; }
	WCString GetLastPolicyDate  () { return m_sLastPolicyDate; }
	...
	SWC_BOOL ExtracrtUpdateFileRequest(OUT INT& nProductType, OUT WCString& sInstalledVersion, OUT WCString& sTypeFull);
	...
	WCString GetUpdateType();       
	WCString GetPolicyFileName();   
...
private:
	...
	WCString m_sSharePC;
	WCString m_sLastPolicyID;
        WCString m_sLastPolicyDate; 
